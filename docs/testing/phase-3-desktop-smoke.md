...
- macOS: `26.5.2`
- Architecture: `arm64`
- Native smoke source commit: `9600cc353aefaf0a2d1f687013c97eb7a717e576`
...
| Quit/reopen native app restoration | PASS | In the earlier debug smoke, manual settlement advanced day 16 to day 17 and quit/reopen restored the state. The final rebuilt app was then launched from commit `9600cc3` and again displayed day 17, cash `¥551,840`, the daily report and the recorded checkpoint. |
