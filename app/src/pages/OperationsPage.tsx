...
export function OperationsPage() {
  ...
  return <main className="page operations-page">
    ...
    {state.phase4 && <FacilityOperationsPanel facilities={Object.values(state.phase4.facilities)} pending={commandPending || finished} onConfigure={(id, policy) => commands.configureFacility(id, policy)} onDevelop={(id, offeringId) => commands.developSignatureOffering(id, offeringId)} onSelectOffering={(id, offeringId) => commands.selectSignatureOffering(id, offeringId)} onSetEnabled={(id, enabled) => commands.setFacilityEnabled(id, enabled)} />}
